...
**Melhorias**
* [x] Transfer Learning (ResNet18): Troca da arquitetura criada do zero por um modelo pré-treinado, fazendo o fine-tuning para classificação binária.
* [x] Data Augmentation: Aplicação de rotações e giros horizontais nas imagens de treino para melhorar a generalização.
* [x] Tratamento de Desbalanceamento: Ajuste dos pesos na função de perda (CrossEntropyLoss), priorizando o Recall de falsos negativos.
* [x] Métricas mais Rigorosas: Avaliação focada em Precision, Recall e F1-Score ao invés de apenas Acurácia.
* [x] Treinamento Otimizado: Aumento para 5 épocas com taxa de aprendizado reduzida (lr=0.0001) para fine-tuning cauteloso.
